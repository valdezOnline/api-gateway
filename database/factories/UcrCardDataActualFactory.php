...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\UcrCardDataActual>
 */
class UcrCardDataActualFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = UcrCardDataActual::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'load_status' => $this->faker->randomElement(['active', 'inactive', 'current', 'old']),
            'created_at' => now(),
            'updated_at' => now()
        ];
    }
    ...
    /**
     * Create record with matching data from staging record.
     */
    public function matchingStaging(array $stagingData): static
    {
        return $this->state(fn(array $attributes) => [
            'net_id' => $stagingData['net_id'],
            'ssn' => $stagingData['ssn'],
            'student_id' => $stagingData['student_id']
        ]);
    }
}
