...
class CourseReservesInstructor implements SearchSourceInterface
{
  ...
  public function results(): SearchResult
  {
    ...
    $this->searchResults->allResultsLink = "https://search.library.ucr.edu/discovery/search?query=course_instructor,contains," . urlencode($this->query) . "&tab=CourseReserves&search_scope=CourseReserves&vid=01CDL_RIV_INST:UCR&offset=0";
